...
export const options = {
  vueI18n: {"fallbackLocale":"uz","messages":{"en":{"welcome":"Welcome"},"ru":{"welcome":"Добро пожаловать"},"uz":{"welcome":"Hush kelibsiz"}}},
  vueI18nLoader: false,
  locales: ["en","ru","uz"],
  defaultLocale: "uz",
  ...
  normalizedLocales: [{"code":"en"},{"code":"ru"},{"code":"uz"}],
  localeCodes: ["en","ru","uz"],
  additionalMessages: [],
}
